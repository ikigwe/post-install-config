...
- Log in to osTicket using the credentials you made during the installation tutorial </h3>
	- If you need help installing osTicket, please see my tutorial [here](https://github.com/ikigwe/osticket-prereqs)
...
- Click [here](https://github.com/ikigwe/ticket-lifecycle) to move on to Part 3 of this three-part tutorial series! 
